...
Configuration is read from the environment and from `~/.agentmemory/.env` (no `export` prefix). 50 recognized variables:

- `AGENTMEMORY_AGENT_SCOPE`
- `AGENTMEMORY_ALLOW_AGENT_SDK`
- `AGENTMEMORY_AUTH_SECRET`
- `AGENTMEMORY_AUTO_COMPRESS`
- `AGENTMEMORY_BACKFILL_ENABLED`
...
- `AGENTMEMORY_METRICS_ENABLED`
- `AGENTMEMORY_METRICS_HOST`
- `AGENTMEMORY_METRICS_PORT`
- `AGENTMEMORY_METRICS_REFRESH_MS`
- `AGENTMEMORY_PROBE_TIMEOUT_MS`
- `AGENTMEMORY_PROJECT_NAME`
- `AGENTMEMORY_PROVIDER`
- `AGENTMEMORY_REFLECT`
- `AGENTMEMORY_REFLECT_CONCURRENCY`
