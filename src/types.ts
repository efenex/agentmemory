...
// Retrieval role of an embedding call. Models trained with task prefixes
// (nomic-embed-text-*) embed queries and documents into deliberately
// different subspaces; providers that support this prepend the matching
// prefix. Callers that index content use "document" (the default);
// search paths pass "query".
